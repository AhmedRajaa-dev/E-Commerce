        ...
        <div>
            <form className="max-w-sm mx-auto" onSubmit={handleSubmit}>
                ...
                <div class="mb-5">
                    ...
                    <input type="password" id="password" className="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body"  required value={password}  onChange={(e) => setPassword(e.target.value)}/>
                </div>
